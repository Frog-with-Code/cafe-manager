...
class TestSQLiteEmployeeRepo:
    ...
    def test_get_most_free(self, repo):
        ...
        e2 = Employee(name="Free-New", employee_id="e2", state=EmployeeState.FREE, rest_start=now)
        e3 = Employee(name="Free-Old", employee_id="e3", state=EmployeeState.FREE, rest_start=now - timedelta(hours=1))
