...
class TestFinanceInvestHandler:
    ...
    def test_handle_success_by_id(self, mock_repo):
        acc_id = uuid4()
    ...
    def test_handle_account_not_found(self, mock_repo):
...
class TestFinanceStatsHandler:
    ...
    def test_handle_profit_stats(self, mock_repo):
        acc_id = uuid4()
        ...
        handler = FinanceStatsHandler(mock_repo)
    ...
    def test_handle_loss_stats(self, mock_repo):
...
class TestFinanceSetPrimaryHandler:
    ...
    def test_handle_success(self, mock_repo):
        acc_id = uuid4()
        handler = FinanceSetPrimaryHandler(mock_repo)
